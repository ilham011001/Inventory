...
class Dashboard extends CI_Controller
{
	public function __construct()
	{
		...
		if($this->session->userdata('is_logged') == FALSE)
			redirect('auth');
		$this->session->set_flashdata(array('active' => "dashboard"));
	}
	...
	public function index()
	{
		$data = array(
			...
			'barang'     => $this->barang_model->num_barang(),
			'distributor'=> $this->distributor_model->num_dist(),
			'user'       => $this->user_model->num_user()
		);
